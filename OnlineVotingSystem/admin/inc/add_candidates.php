                ...
                ?>
                            <tr>
                                ...
                                <td> 
                                    ...
                                    <a id="edi"  onclick="return confirm('Are you really want to edit the candidate details?')" data-id="<?php echo $row['id']?>" href="index.php?edit_page=<?php echo $row['id']; ?>" class="btn btn-sm btn-warning"> Edit  </a>
                                    <!-- real<a href="#" class="btn btn-sm btn-danger"> Delete </a> -->
                                    <!-- change -->
                                    
                                    <button class="btn btn-sm btn-danger" onclick="return DeleteData(<?php echo $election_id; ?>)"> Delete </button>
                                    <!-- change  -->
                                </td>
                            </tr>   
                <?php

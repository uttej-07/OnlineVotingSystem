...
<body>
                        ...
                        <div class="d-flex justify-content-center form_container">
                            <form method="POST">
                                ...
                                <div class="input-group mb-2">
                                    ...
                                    <label for="psw"></label>
                                    <input type="password" name="su_password" class="form-control input_pass" id="psw" title="Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" placeholder="Password" required />
  ...
  <p id="length" class="invalid">Minimum <b>8 characters</b></p>
                                ...
                                <div class="input-group mb-2">
                                    ...
                                    <input type="password" name="su_retype_password" class="form-control input_pass" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" placeholder="Retype Password" required />
                                </div>
 ...
 <!-- <div class="d-flex justify-content-center mt-3 login_container">
                            <input type="button" value="verify" name="loginBtn" class="btn login_btn" 
onClick="window.location='otpp/index1.php';" required />
                        </div>
                        <br> -->
...
<?php 
    ...
    }else if(isset($_POST['loginBtn']))
    {
        ...
        if(mysqli_num_rows($fetchingData) > 0)
        {
            ...
            ?>
                    <script> location.assign("index1.php"); </script>
            <?php
                }
